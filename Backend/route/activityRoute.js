...
activityRoutes.post("/log", authMiddleware(['employee', 'intern']), upload.single('image'), logActivity);
...
activityRoutes.patch("/update", authMiddleware(['admin', 'employee', 'intern']), upload.single('image'), updateActivity);
