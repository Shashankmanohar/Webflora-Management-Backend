        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1f2937; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                    <div style="background-color: #0f172a; color: white; padding: 30px; text-align: center; border-bottom: 2px solid #ff4e1b;">
                        <img src="cid:webfloralogo" alt="Webflora Logo" style="max-height: 48px; width: auto; margin-bottom: 12px;">
                        <h1 style="margin: 0; font-size: 24px; font-weight: 800; letter-spacing: -0.025em; color: #ffffff;">Welcome to the Team!</h1>
                    </div>
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #1f2937; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                    <div style="background-color: #0f172a; color: white; padding: 30px; text-align: center; border-bottom: 2px solid #ff4e1b;">
                        <img src="cid:webfloralogo" alt="Webflora Logo" style="max-height: 48px; width: auto; margin-bottom: 12px;">
                        <h1 style="margin: 0; font-size: 24px; font-weight: 800; letter-spacing: -0.025em; color: #ffffff;">New Assignment!</h1>
                        <p style="margin: 6px 0 0 0; opacity: 0.85; font-size: 14px; color: #e2e8f0;">A new project has been handed over to you.</p>
                    </div>
                    <div style="padding: 40px;">
